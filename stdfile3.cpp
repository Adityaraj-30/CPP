...
class Student
{
	private: string s[100];  //String Array to store each word read from file in separate destination.
...
{
	input.open("filename.txt"); //Opening File
	if(!input)
	{
...
{
	int a=1,b=2,c=5;  //temporary variables to skip class and year of student data and changing line after marks of each student is printed.
